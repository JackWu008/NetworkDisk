...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            AppUtils.getContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        } else {
            AppUtils.getContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        }
    }
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) AppUtils.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
